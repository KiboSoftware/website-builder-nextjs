...
import { ComponentProps, contentSdk } from "@webiny/website-builder-nextjs";
import { useProductsByIds } from "@/src/sampleApi/useKiboProductsByIds";
...
export function KiboProductRecommendations({ inputs }: ProductRecommendationsProps) {
